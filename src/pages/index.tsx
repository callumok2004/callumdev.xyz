...
import {
  SiDocker, SiGit, SiGo, SiJavascript, SiNextdotjs as SiNextJs, SiNodedotjs as SiNodeJs,
  SiPostgresql, SiPrisma, SiPython, SiReact, SiRedis, SiStyledcomponents as SiStyledComponents,
  SiSwift, SiTailwindcss as SiTailwindCSS, SiTypescript, SiVisualstudiocode, SiYarn
} from "react-icons/si";
...
export async function getStaticProps() {
  const stats = await fetch("https://api.github-star-counter.workers.dev/user/cnrad").then(res => res.json()),
    repos = await fetch("https://api.github.com/users/cnrad/repos?type=owner&per_page=100").then(res =>
      res.json()
    ),
